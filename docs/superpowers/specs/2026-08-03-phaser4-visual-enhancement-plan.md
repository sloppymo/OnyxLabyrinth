...
- **Palette-crumble death (P1):** Shipped in `feat/palette-crumble-death` and merged as PR #7. Passed manual WebGL verification at 20%, 50%, 80%, and 100% death progress against red skeleton, acid puddle, and boss-sized red skeleton; two-simultaneous-death independence confirmed; revive/reset removes filters and ash.
