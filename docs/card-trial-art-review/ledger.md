...
The live source contains 22 unique card IDs (24 entries across the two 12-card lists because
`nip` and `staff` each appear twice).
...
| `brace` | Brace | Rat King | 1 | Gain 6 Guard. | Missing |
...
| `king-of-the-heap` | King of the Heap | Rat King | 2 | Deal 7 and gain 8 Guard. Front: +3 damage. | Existing final |
| `staff` | Staff | Old Man | 1 | Deal 6. | Existing final |
| `ward` | Ward | Old Man | 1 | Gain 7 Guard. | Missing |
| `crack` | Crack | Old Man | 1 | Deal 5. Open the target. | Missing |
| `split-bone` | Split Bone | Old Man | 1 | Deal 4. Open the target. | Missing |
| `full-stop` | Full Stop | Old Man | 2 | Deal 8. Consume Opened: deal 8 more to that enemy. | Missing |
| `cut-the-line` | Cut the Line | Old Man | 1 | Deal 5. Consume Opened: deal 5 to a second enemy. | Missing |
| `threshold` | Threshold | Old Man | 1 | Deal 5. Front: +4. | Missing |
| `from-afar` | From Afar | Old Man | 1 | Deal 5. Back: gain 3 Guard. | Missing |
| `parting-blow` | Parting Blow | Old Man | 1 | Deal 4, then move to Back. | Missing |
| `extinguish` | Extinguish | Old Man | 2 | Deal 4 to every enemy. | Missing |
| `stand-and-die` | Stand and Die | Old Man | 2 | Deal 8 and gain 9 Guard. Front: +3 damage. | Missing |
...
| Card | Primary visual verb | Composition / dominant silhouette | Secondary element | Palette / background | Must include / avoid |
| --- | --- | --- | --- | --- | --- |
| Ward | ward | Old Man plants the staff and braces a compact angular ward around himself. | Thin pale-gold/blue block shape. | Blue-purple robe, dull gold wrap, brown staff, dark arch. | Defensive posture; no literal HUD shield or rune circle. |
| Crack | fracture | Staff lands against one enemy silhouette; a single hard crack splits the target's shape. | One opened enemy seam. | Near-black, muted blue, brown, restrained violet/red. | One target and one fracture; no blood spray. |
| Split Bone | split | Close staff strike against a bone-white enemy limb or mask, with one diagonal break. | Sparse bone fragments. | Robe blue-purple, bone pale, dark stone. | Chunky fracture graphic; no anatomy microtexture. |
...
| Cut the Line | sever | A staff sweep slices a line between two enemy silhouettes, with one target behind the break. | Two separated enemy masses. | Slate blue/purple and one pale-gold stroke. | Reposition/second-target read; no text, arrows, or meters. |
| Threshold | threshold | Graphic doorway/ledge with a single advancing Old Man silhouette crossing its boundary. | Pale wave/line at the threshold. | Slate, muted teal, bone, restrained gold. | Environment/abstract card; avoid portrait repetition. |
| From Afar | reach | Old Man small in the lower corner; long staff or occult reach connects to a distant enemy. | Large negative space and one target. | Blue-purple robe, brown staff, dark stone, one violet accent. | Distance and Back read; no centered orb. |
| Parting Blow | retreat | Old Man turns away after a short staff strike, robe and staff drawing back on a diagonal. | Receding enemy silhouette. | Blue-purple, brown, muted gold, dark floor. | Deal then movement to Back; no literal `BACK` label. |
| Extinguish | extinguish | Old Man stands in a dark field as several small enemy silhouettes are swallowed by one broad shadow plane. | Three large dark shapes, not particles. | Near-black, blue-purple, one dim violet ember. | All-enemy scale; no fireball or smoke bloom. |
| Stand and Die | stand | Elderly Old Man planted squarely with staff vertical, absorbing the room's pressure. | Low enemy silhouettes stopped at the foreground. | Blue-purple robe, dull gold wrap, brown staff, near-black arch. | Guard + Front resolve; no armor or archmage transformation. |

## Production notes

- Source masters and runtime exports are both native 128×96.
- Existing final art (`nip`, `king-of-the-heap`, `tide`, `swarm-the-wound`, `staff`) is the binding style reference and is not regenerated.
...
| `staff` | Existing approved final | Preserved unchanged | 41 | `art/card-trial/cards/staff.aseprite` | `public/assets/card-trial/cards/staff.png` | pass |
| `ward` | Inherited PixelLab candidate | Near-black normalization; defensive silhouette review | 36 | `art/card-trial/cards/ward.aseprite` | `public/assets/card-trial/cards/ward.png` | pass |
| `crack` | Inherited PixelLab candidate | Near-black normalization; single fracture review | 35 | `art/card-trial/cards/crack.aseprite` | `public/assets/card-trial/cards/crack.png` | pass |
| `split-bone` | Inherited PixelLab candidate | Near-black normalization; diagonal impact review | 35 | `art/card-trial/cards/split-bone.aseprite` | `public/assets/card-trial/cards/split-bone.png` | pass |
...
| `cut-the-line` | Inherited PixelLab candidate | Near-black normalization; two-target separation review | 60 | `art/card-trial/cards/cut-the-line.aseprite` | `public/assets/card-trial/cards/cut-the-line.png` | pass |
| `threshold` | Inherited PixelLab candidate | Near-black normalization; graphic/environment review | 31 | `art/card-trial/cards/threshold.aseprite` | `public/assets/card-trial/cards/threshold.png` | pass |
| `from-afar` | Inherited PixelLab candidate | Near-black normalization; distance/negative-space review | 30 | `art/card-trial/cards/from-afar.aseprite` | `public/assets/card-trial/cards/from-afar.png` | pass |
| `parting-blow` | Inherited PixelLab candidate | Near-black normalization; retreat-direction review | 33 | `art/card-trial/cards/parting-blow.aseprite` | `public/assets/card-trial/cards/parting-blow.png` | pass |
| `extinguish` | Inherited PixelLab candidate | Near-black normalization; broad shadow-mass review | 43 | `art/card-trial/cards/extinguish.aseprite` | `public/assets/card-trial/cards/extinguish.png` | pass |
| `stand-and-die` | Inherited PixelLab candidate | Near-black normalization; planted Old Man silhouette review | 43 | `art/card-trial/cards/stand-and-die.aseprite` | `public/assets/card-trial/cards/stand-and-die.png` | pass |
