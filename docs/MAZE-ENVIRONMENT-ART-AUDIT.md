...
- The predecessor corridor art-direction prompt (fog, torch, and door panels) was
  already executed (commits `ca927a9`…`0ff6394`). Do not re-litigate it; its output
  is now §10 of the tileset guide. The one-off prompt itself is no longer retained.
