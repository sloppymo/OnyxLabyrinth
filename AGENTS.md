...
| `src/engine/audio.ts` | Procedural Web Audio: ambient drone, footsteps, door sounds, and the **boss combat bed** (`startBossCombat`/`stopBossCombat`, `CFG.bossBed`). Sample-backed SFX layer is separate — see the audio pitfall below. |
