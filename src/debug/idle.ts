...
// ending auto-play, and no unfinished combat playback choreography. Menus,
// camp, town, and combat's non-playback phases (palette/select*/result) all
// count as idle-awaiting-input on purpose.
