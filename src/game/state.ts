...
// (title, town, combat, camp, game_over) are part of the GameMode union so
// future steps can transition into them without widening the type.
...
export function createGameState(floor: FloorDef, party?: import("./party").Character[]): GameState {
